"""Tests for mesh material loading from DAE files."""
...
def test_mesh_material_loading(ctx):
    """Test that mesh materials load correctly from DAE file."""
    locator = ctx.keep(TesseractSupportResourceLocator())
    scene = tesseract_urdf.parseURDFString(MESH_URDF, locator)
