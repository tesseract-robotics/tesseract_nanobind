...
EXAMPLES = ["freespace_ompl", "car_seat", "pick_and_place", "glass_upright", "basic_cartesian", "raster", "online_planning", "chain", "freespace_hybrid", "puzzle_piece_auxillary_axes", "scene_graph"]
