...
class URParameters:
    ...
    @overload
    def __init__(
        self, d1: float, a2: float, a3: float, d4: float, d5: float, d6: float
    ) -> None: ...
    @property
    def d1(self) -> float: ...
    @d1.setter
...
class KinGroupIKInput:
    ...
    @overload
    def __init__(
        self, pose: "Eigen::Transform<double, 3, 1, 0>", working_frame: str, tip_link_name: str
    ) -> None: ...
    @property
...
class ForwardKinematics:
    def calcFwdKin(
        self, joint_angles: Annotated[NDArray[numpy.float64], dict(shape=(None,), writable=False)]
    ) -> dict[str, "Eigen::Transform<double, 3, 1, 0>"]: ...
    def calcJacobian(
        self,
        joint_angles: Annotated[NDArray[numpy.float64], dict(shape=(None,), writable=False)],
        link_name: str,
    ) -> Annotated[NDArray[numpy.float64], dict(shape=(None, None), order="F")]: ...
...
class InverseKinematics:
    def calcInvKin(
        self,
        tip_link_poses: Mapping[str, "Eigen::Transform<double, 3, 1, 0>"],
        seed: Annotated[NDArray[numpy.float64], dict(shape=(None,), writable=False)],
...
class JointGroup:
    def __init__(
        ...
        scene_state: "tesseract_scene_graph::SceneState",
    ) -> None: ...
    def calcFwdKin(
        self, joint_angles: Annotated[NDArray[numpy.float64], dict(shape=(None,), writable=False)]
    ) -> dict[str, "Eigen::Transform<double, 3, 1, 0>"]: ...
    ...
    def calcJacobianWithPoint(
        self,
        joint_angles: Annotated[NDArray[numpy.float64], dict(shape=(None,), writable=False)],
        link_name: str,
        link_point: Annotated[NDArray[numpy.float64], dict(shape=(3), order="C")],
    ) -> Annotated[NDArray[numpy.float64], dict(shape=(None, None), order="F")]: ...
    def getJointNames(self) -> list[str]: ...
    ...
    def checkJoints(
        self, vec: Annotated[NDArray[numpy.float64], dict(shape=(None,), writable=False)]
    ) -> bool: ...
...
class KinematicGroup(JointGroup):
    ...
    def calcInvKin(
        self,
        tip_link_pose: KinGroupIKInput,
        seed: Annotated[NDArray[numpy.float64], dict(shape=(None,), writable=False)],
    ) -> list[Annotated[NDArray[numpy.float64], dict(shape=(None,), order="C")]]: ...
    @overload
    def calcInvKin(
        self,
        tip_link_poses: KinGroupIKInputs,
        seed: Annotated[NDArray[numpy.float64], dict(shape=(None,), writable=False)],
    ) -> list[Annotated[NDArray[numpy.float64], dict(shape=(None,), order="C")]]: ...
    def calcInvKinMultiple(
        self,
        tip_link_poses: Sequence[KinGroupIKInput],
        seed: Annotated[NDArray[numpy.float64], dict(shape=(None,), writable=False)],
    ) -> list[Annotated[NDArray[numpy.float64], dict(shape=(None,), order="C")]]: ...
...
def getRedundantSolutions(
    sol: Annotated[NDArray[numpy.float64], dict(shape=(None,), writable=False)],
    limits: Annotated[NDArray[numpy.float64], dict(shape=(None, 2), writable=False)],
    redundancy_capable_joints: Sequence[int],
) -> list[Annotated[NDArray[numpy.float64], dict(shape=(None,), order="C")]]:
    """
