...
def cast_DescartesSolverProfileD(
...
class DescartesDefaultPlanProfileD(DescartesPlanProfileD):
    ...
    @property
    def vertex_collision_check_config(
        self,
    ...
    @property
    def edge_collision_check_config(
        self,
    ) -> tesseract_robotics.tesseract_collision._tesseract_collision.CollisionCheckConfig: ...
...
def cast_DescartesPlanProfileD(
