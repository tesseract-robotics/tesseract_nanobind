...
def ProfileDictionary_addTrajOptIfoptPlanProfile(
    dict: tesseract_robotics.tesseract_command_language._tesseract_command_language.ProfileDictionary,
    ns: str,
    profile_name: str,
    profile: TrajOptIfoptPlanProfile,
) -> None:
    """Add TrajOptIfopt plan profile to ProfileDictionary"""

def ProfileDictionary_addTrajOptIfoptCompositeProfile(
    dict: tesseract_robotics.tesseract_command_language._tesseract_command_language.ProfileDictionary,
    ns: str,
    profile_name: str,
    profile: TrajOptIfoptCompositeProfile,
) -> None:
    """Add TrajOptIfopt composite profile to ProfileDictionary"""

def ProfileDictionary_addTrajOptIfoptSolverProfile(
    dict: tesseract_robotics.tesseract_command_language._tesseract_command_language.ProfileDictionary,
    ns: str,
    profile_name: str,
    profile: TrajOptIfoptSolverProfile,
) -> None:
