...
class TaskComposerExecutor:
    def getName(self) -> str: ...
    def run(
        self, node: TaskComposerNode, data_storage: TaskComposerDataStorage, dotgraph: bool = False
    ) -> TaskComposerFuture: ...
...
def AnyPoly_wrap_CompositeInstruction(
    instruction: "tesseract_planning::CompositeInstruction",
) -> AnyPoly:
...
def AnyPoly_as_CompositeInstruction(
    any_poly: AnyPoly,
