...
class OMPLPlanProfile(tesseract_robotics.tesseract_command_language._tesseract_command_language.Profile):
    def getKey(self) -> int: ...
...
def OMPLPlanProfile_as_ProfileConstPtr(profile: OMPLPlanProfile) -> tesseract_robotics.tesseract_command_language._tesseract_command_language.Profile:
    """
    Convert OMPLPlanProfile to Profile::ConstPtr for use with ProfileDictionary.addProfile
    """

def ProfileDictionary_addOMPLProfile(dict: tesseract_robotics.tesseract_command_language._tesseract_command_language.ProfileDictionary, ns: str, profile_name: str, profile: OMPLPlanProfile) -> None:
