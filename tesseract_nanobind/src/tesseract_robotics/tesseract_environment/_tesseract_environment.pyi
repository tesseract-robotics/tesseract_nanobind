...
class ChangeCollisionMarginsCommand(Command):
    @overload
    def __init__(self, default_margin: float, override_type: tesseract_robotics.tesseract_common._tesseract_common.CollisionMarginOverrideType = tesseract_robotics.tesseract_common._tesseract_common.CollisionMarginOverrideType.OVERRIDE_DEFAULT_MARGIN) -> None: ...

    @overload
    def __init__(self, collision_margin_data: tesseract_robotics.tesseract_common._tesseract_common.CollisionMarginData, override_type: tesseract_robotics.tesseract_common._tesseract_common.CollisionMarginOverrideType = tesseract_robotics.tesseract_common._tesseract_common.CollisionMarginOverrideType.REPLACE) -> None: ...

    def getCollisionMarginData(self) -> tesseract_robotics.tesseract_common._tesseract_common.CollisionMarginData: ...

    def getCollisionMarginOverrideType(self) -> tesseract_robotics.tesseract_common._tesseract_common.CollisionMarginOverrideType: ...
