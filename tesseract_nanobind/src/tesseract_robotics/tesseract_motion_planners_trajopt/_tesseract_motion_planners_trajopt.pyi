...
class TrajOptDefaultCompositeProfile(TrajOptCompositeProfile):
    def __init__(self) -> None: ...
    @property
    def contact_test_type(
        self,
    ) -> tesseract_robotics.tesseract_collision._tesseract_collision.ContactTestType: ...
    @contact_test_type.setter
    def contact_test_type(
        self, arg: tesseract_robotics.tesseract_collision._tesseract_collision.ContactTestType, /
    ) -> None: ...
    @property
