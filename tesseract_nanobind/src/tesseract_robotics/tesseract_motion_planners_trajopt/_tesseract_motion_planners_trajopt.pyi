...
class CollisionCostConfig:
    ...
    @property
    def use_weighted_sum(self) -> bool: ...

    @use_weighted_sum.setter
    def use_weighted_sum(self, arg: bool, /) -> None: ...
    ...
    @property
    def safety_margin_buffer(self) -> float: ...

    @safety_margin_buffer.setter
    def safety_margin_buffer(self, arg: float, /) -> None: ...

    @property
    def coeff(self) -> float: ...

    @coeff.setter
    def coeff(self, arg: float, /) -> None: ...
...
class TrajOptPlanProfile(tesseract_robotics.tesseract_command_language._tesseract_command_language.Profile):
    def getKey(self) -> int: ...
...
class TrajOptDefaultCompositeProfile(TrajOptCompositeProfile):
    ...
    @property
    def contact_test_type(self) -> tesseract_robotics.tesseract_collision._tesseract_collision.ContactTestType: ...

    @contact_test_type.setter
    def contact_test_type(self, arg: tesseract_robotics.tesseract_collision._tesseract_collision.ContactTestType, /) -> None: ...

    @property
    def collision_cost_config(self) -> CollisionCostConfig: ...

    @collision_cost_config.setter
    def collision_cost_config(self, arg: CollisionCostConfig, /) -> None: ...

    @property
    def collision_constraint_config(self) -> CollisionConstraintConfig: ...

    @collision_constraint_config.setter
    def collision_constraint_config(self, arg: CollisionConstraintConfig, /) -> None: ...
...
def ProfileDictionary_addTrajOptPlanProfile(dict: tesseract_robotics.tesseract_command_language._tesseract_command_language.ProfileDictionary, ns: str, profile_name: str, profile: TrajOptPlanProfile) -> None:
