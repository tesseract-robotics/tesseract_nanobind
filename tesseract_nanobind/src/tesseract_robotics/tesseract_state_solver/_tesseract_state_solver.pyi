...
class SceneState:
    ...
    def link_transforms(
        self, arg: Mapping[str, "Eigen::Transform<double, 3, 1, 0>"], /
    ) -> None: ...
    @property
...
class StateSolver:
    ...
    @overload
    def getState(
        self, joint_values: Annotated[NDArray[numpy.float64], dict(shape=(None,), writable=False)]
    ) -> SceneState: ...
    @overload
...
class MutableStateSolver(StateSolver):
    ...
    def addLink(
        self, link: "tesseract_scene_graph::Link", joint: "tesseract_scene_graph::Joint"
    ) -> bool: ...
