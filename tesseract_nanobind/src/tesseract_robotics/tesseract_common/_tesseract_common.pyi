...
class Quaterniond:
    ...
    @overload
    def __init__(
        self, rotation_matrix: Annotated[NDArray[numpy.float64], dict(shape=(3, 3), order="F")]
    ) -> None: ...
    def w(self) -> float: ...
    def x(self) -> float: ...
    def y(self) -> float: ...
...
class AngleAxisd:
    def __init__(
        self, arg0: float, arg1: Annotated[NDArray[numpy.float64], dict(shape=(3), order="C")], /
    ) -> None: ...
    def toRotationMatrix(
        self,
    ) -> Annotated[NDArray[numpy.float64], dict(shape=(3, 3), order="F")]: ...
...
class KinematicLimits:
    ...
    def joint_limits(
        self,
    ) -> Annotated[NDArray[numpy.float64], dict(shape=(None, 2), order="F")]: ...
    @joint_limits.setter
    def joint_limits(
        self, arg: Annotated[NDArray[numpy.float64], dict(shape=(None, 2), order="F")], /
    ) -> None: ...
    @property
    def velocity_limits(
        self,
...
class VectorVector3d:
    ...
    def __setitem__(
        self, arg0: int, arg1: Annotated[NDArray[numpy.float64], dict(shape=(3), order="C")], /
    ) -> None: ...
    def append(
        self, arg: Annotated[NDArray[numpy.float64], dict(shape=(3), order="C")], /
    ) -> None: ...
