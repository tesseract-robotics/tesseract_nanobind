...
class ContactManagerConfig:
    ...
    def margin_data_override_type(self, arg: "tesseract_common::CollisionMarginOverrideType", /) -> None: ...
...
class ContactManagersPluginFactory:
    ...
    @overload
    def __init__(self, config_path: "boost::filesystem::path", locator: "tesseract_common::ResourceLocator") -> None: ...
