...
class JointPosition(tesseract_robotics.ifopt._ifopt.VariableSet):
    def __init__(
        self,
        init_value: Annotated[NDArray[numpy.float64], dict(shape=(None,), writable=False)],
    ...
    def SetVariables(
        self, x: Annotated[NDArray[numpy.float64], dict(shape=(None,), order="C")]
    ) -> None:
    ...
    def SetBounds(
        self, bounds: Annotated[NDArray[numpy.float64], dict(shape=(None, 2), writable=False)]
    ) -> None:
...
def interpolate(
    start: Annotated[NDArray[numpy.float64], dict(shape=(None,), writable=False)],
    end: Annotated[NDArray[numpy.float64], dict(shape=(None,), writable=False)],
    steps: int,
...
def toBounds(
    limits: Annotated[NDArray[numpy.float64], dict(shape=(None, 2), writable=False)],
) -> list[tesseract_robotics.ifopt._ifopt.Bounds]:
...
class CartPosConstraint(tesseract_robotics.ifopt._ifopt.ConstraintSet):
    def __init__(
        self, info: CartPosInfo, position_var: JointPosition, name: str = "CartPos"
    ) -> None:
        """Create Cartesian position constraint"""

    def CalcValues(
        self, joint_vals: Annotated[NDArray[numpy.float64], dict(shape=(None,), writable=False)]
...
class JointPosConstraint(tesseract_robotics.ifopt._ifopt.ConstraintSet):
    def __init__(
        self,
        targets: Annotated[NDArray[numpy.float64], dict(shape=(None,), order="C")],
        position_vars: Sequence[JointPosition],
        coeffs: Annotated[NDArray[numpy.float64], dict(shape=(None,), order="C")],
        name: str = "JointPos",
    ) -> None:
...
class TrajOptCollisionConfig:
    ...
    @property
    def contact_manager_config(self) -> "tesseract_collision.ContactManagerConfig": ...
    @contact_manager_config.setter
    def contact_manager_config(
        self, arg: "tesseract_collision.ContactManagerConfig", /
    ) -> None: ...
    @property
    def collision_check_config(self) -> "tesseract_collision.CollisionCheckConfig": ...
    @collision_check_config.setter
    def collision_check_config(
        self, arg: "tesseract_collision.CollisionCheckConfig", /
    ) -> None: ...
    @property
...
class DiscreteCollisionConstraint(tesseract_robotics.ifopt._ifopt.ConstraintSet):
    def __init__(
        self,
        collision_evaluator: DiscreteCollisionEvaluator,
        position_var: JointPosition,
        max_num_cnt: int = 1,
        fixed_sparsity: bool = False,
        name: str = "DiscreteCollisionV3",
    ) -> None: ...
    def GetValues(self) -> Annotated[NDArray[numpy.float64], dict(shape=(None,), order="C")]: ...
    def CalcValues(
        self, joint_vals: Annotated[NDArray[numpy.float64], dict(shape=(None,), writable=False)]
...
class ContinuousCollisionConstraint(tesseract_robotics.ifopt._ifopt.ConstraintSet):
    def __init__(
        self,
        collision_evaluator: ContinuousCollisionEvaluator,
        position_var0: JointPosition,
        position_var1: JointPosition,
        fixed0: bool = False,
        fixed1: bool = False,
        max_num_cnt: int = 1,
        fixed_sparsity: bool = False,
        name: str = "LVSCollision",
    ) -> None: ...
    def GetValues(self) -> Annotated[NDArray[numpy.float64], dict(shape=(None,), order="C")]: ...
...
class CartLineConstraint(tesseract_robotics.ifopt._ifopt.ConstraintSet):
    ...
    def GetLinePoint(
        self,
        source_tf: "Eigen::Transform<double, 3, 1, 0>",
        target_tf1: "Eigen::Transform<double, 3, 1, 0>",
        target_tf2: "Eigen::Transform<double, 3, 1, 0>",
...
class DiscreteCollisionNumericalConstraint(tesseract_robotics.ifopt._ifopt.ConstraintSet):
    def __init__(
        ...
        max_num_cnt: int = 1,
        fixed_sparsity: bool = False,
        name: str = "DiscreteCollisionNumerical",
    ) -> None:
...
class InverseKinematicsConstraint(tesseract_robotics.ifopt._ifopt.ConstraintSet):
    def __init__(
        self,
        target_pose: "Eigen::Transform<double, 3, 1, 0>",
        kinematic_info: InverseKinematicsInfo,
        constraint_var: JointPosition,
        seed_var: JointPosition,
        name: str = "InverseKinematics",
    ) -> None:
        """
