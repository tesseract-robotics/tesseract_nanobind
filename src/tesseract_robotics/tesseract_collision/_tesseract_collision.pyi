...
class ContactResult:
    ...
    @property
    def nearest_points(self) -> list[Annotated[NDArray[numpy.float64], dict(shape=(3), order='C')]]: ...

    @nearest_points.setter
    def nearest_points(self, arg: Sequence[Annotated[NDArray[numpy.float64], dict(shape=(3), order='C')]], /) -> None: ...
...
class ContactManagerConfig:
    ...
    @property
    def default_margin(self) -> float | None: ...

    @default_margin.setter
    def default_margin(self, arg: float, /) -> None: ...

    @property
    def pair_margin_override_type(self) -> "tesseract_common::CollisionMarginPairOverrideType": ...

    @pair_margin_override_type.setter
...
class DiscreteContactManager:
    ...
    def setPairCollisionMarginData(self, name1: str, name2: str, collision_margin: float) -> None: ...

    def getCollisionMarginData(self) -> "tesseract_common::CollisionMarginData": ...

    def addCollisionObject(self, name: str, mask_id: int, shapes: Sequence["tesseract_geometry::Geometry"], shape_poses: Sequence["Eigen::Transform<double, 3, 1, 0>"], enabled: bool = True) -> bool: ...

    def getCollisionObjectGeometries(self, name: str) -> list["tesseract_geometry::Geometry"]: ...

    def getCollisionObjectGeometriesTransforms(self, name: str) -> list["Eigen::Transform<double, 3, 1, 0>"]: ...

    def contactTest(self, collisions: ContactResultMap, request: ContactRequest) -> None: ...

    def clone(self) -> DiscreteContactManager: ...
...
class ContinuousContactManager:
    ...
    def setCollisionObjectsTransformCast(self, name: str, pose1: "Eigen::Transform<double, 3, 1, 0>", pose2: "Eigen::Transform<double, 3, 1, 0>") -> None: ...
    ...
    def clone(self) -> ContinuousContactManager: ...
