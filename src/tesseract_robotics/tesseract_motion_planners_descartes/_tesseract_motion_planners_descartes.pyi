...
class DescartesMoveProfileD(tesseract_robotics.tesseract_command_language._tesseract_command_language.Profile):
    ...
    def createWaypointSampler(self, move_instruction: tesseract_robotics.tesseract_command_language._tesseract_command_language.MoveInstructionPoly, composite_manip_info: tesseract_robotics.tesseract_common._tesseract_common.ManipulatorInfo, env: "tesseract::environment::Environment") -> DescartesWaypointSamplerD: ...

    def createEdgeEvaluator(self, move_instruction: tesseract_robotics.tesseract_command_language._tesseract_command_language.MoveInstructionPoly, composite_manip_info: tesseract_robotics.tesseract_common._tesseract_common.ManipulatorInfo, env: "tesseract::environment::Environment") -> DescartesEdgeEvaluatorD: ...

    def createStateEvaluator(self, move_instruction: tesseract_robotics.tesseract_command_language._tesseract_command_language.MoveInstructionPoly, composite_manip_info: tesseract_robotics.tesseract_common._tesseract_common.ManipulatorInfo, env: "tesseract::environment::Environment") -> DescartesStateEvaluatorD: ...
...
class DescartesDefaultMoveProfileD(DescartesMoveProfileD):
    ...
    @property
    def vertex_contact_manager_config(self) -> tesseract_robotics.tesseract_collision._tesseract_collision.ContactManagerConfig: ...

    @vertex_contact_manager_config.setter
    def vertex_contact_manager_config(self, arg: tesseract_robotics.tesseract_collision._tesseract_collision.ContactManagerConfig, /) -> None: ...
    ...
    @property
    def edge_contact_manager_config(self) -> tesseract_robotics.tesseract_collision._tesseract_collision.ContactManagerConfig: ...

    @edge_contact_manager_config.setter
    def edge_contact_manager_config(self, arg: tesseract_robotics.tesseract_collision._tesseract_collision.ContactManagerConfig, /) -> None: ...
...
def sampleToolZAxis(tool_pose: tesseract_robotics.tesseract_common._tesseract_common.Isometry3d, resolution: float, minimum: float, maximum: float) -> list[tesseract_robotics.tesseract_common._tesseract_common.Isometry3d]:
    """
    Sample poses rotated about the tool Z axis from minimum to maximum at resolution (radians).
    """

def sampleToolXAxis(tool_pose: tesseract_robotics.tesseract_common._tesseract_common.Isometry3d, resolution: float, minimum: float, maximum: float) -> list[tesseract_robotics.tesseract_common._tesseract_common.Isometry3d]:
    """
